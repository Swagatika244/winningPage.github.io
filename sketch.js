...
// STATE_3
  var lastName;
  var shoot1, shoot2, shootGroup1, shootGroup2, shootImg;
...
function preload(){
  ...
  backgroundImg4 = loadImage('assets/backgroundImg/background16.jpg ');
  ...
  shootImg = loadImage('assets/yoyo.png');
...
function state_2_setup(){
  ...
  // state2 === 2
    ...
    startBtn.mouseClicked(()=>{
      var balloon = createSprite(300, 300, 100, 100)
    })
    startBtn.hide();
...
function state_3_setup(){
  ...
  lastName = createElement('h1', "LAND OF DRUIDS");
  lastName.position(17, -120);
...
function shoot(){
    shoot1 = createSprite(400, height/2-160);
    shoot1.addImage(shootImg);
    shoot1.scale = 0.45;
    shootGroup1.add(shoot1);

    shoot2 = createSprite(width - 480, height/2+150);
